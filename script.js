...
places.forEach(place => {
    ...
    marker.on('click', function() {
        ...
        this.setIcon(L.icon({
            ...
            iconSize: [32, 48], // Размер маркера
            iconAnchor: [16, 41], // Якорь иконки
